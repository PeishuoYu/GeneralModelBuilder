...
In this folder, there are:
	bank-data.csv		Training set of the program, containing 400 pieces of data
	test.csv		Testing set, containing 200 pieces of data
...
The folder includes a sample, after I trained the model with training set and made
